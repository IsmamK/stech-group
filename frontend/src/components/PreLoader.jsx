...
function PreLoader() {
  ...
  const preloadpath1 = useRef(null);
  const preloadpath2 = useRef(null);
  const preloadpath3 = useRef(null);

  useEffect(() => {
    gsap.from(preloadpath1.current, {
      duration: 1,
      delay: 1,
      ease: "power2.in",
      y: 100,
    ...
    gsap.to(preloadpath1.current, { y: 0 });

    gsap.from(preloadpath2.current, {
      duration: 1,
      delay: 1,
      ease: "power2.in",
      y: 100,
    ...
    gsap.to(preloadpath2.current, { y: 0 });

    gsap.from(preloadpath3.current, {
      duration: 1,
      delay: 1,
      ease: "power2.in",
      y: -100,
    ...
    gsap.to(preloadpath3.current, { y: 0 });

    setTimeout(() => {
      if (preloader.current) {
        preloader.current.classList.add('d-none');
      }
    }, 2000);
  }, []);

  return (
    <div className="preloader" id="preloader" ref={preloader}>
