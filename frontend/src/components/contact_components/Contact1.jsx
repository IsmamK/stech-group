...
const ContactForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Validate data
        const validatedData = {
          sectionTitle: result.sectionTitle || "Get In Touch",
          sectionSubtitle: result.sectionSubtitle || "We're ready to assist you with your facility management needs",
          contactInfo: result.contactInfo || {
            phone: "+966 56 705 5580",
            email: "info@kaftaroperations.com",
            address: "9191 Al Olaya Dist. Riyadh 12611, Saudi Arabia"
          },
          workingHours: result.workingHours || "Sunday - Thursday: 8:00 AM - 5:00 PM"
        };
  ...
  return (
    <section className="relative py-20 pt-32 overflow-hidden bg-white max-w-7xl mx-auto">
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <label htmlFor="name" className="block text-sm font-medium text-[#040404] mb-2">
                      Name <span className="text-[#f9b414]">*</span>
                    </label>
                    <input
                      type="text"
                      id="name"
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <label htmlFor="email" className="block text-sm font-medium text-[#040404] mb-2">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <label htmlFor="phone" className="block text-sm font-medium text-[#040404] mb-2">
                      Phone
                    </label>
                    <input
                      type="tel"
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <label htmlFor="subject" className="block text-sm font-medium text-[#040404] mb-2">
                      Subject
                    </label>
                    <input
                      type="text"
                  ...
                  >
                    <label htmlFor="message" className="block text-sm font-medium text-[#040404] mb-2">
                      Message <span className="text-[#f9b414]">*</span>
                    </label>
                    <textarea
                      id="message"
                      name="message"
