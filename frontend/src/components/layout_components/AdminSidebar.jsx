  ...
  return (
    ...
    <div className='w-[350px]'>
      ...
      <ul className='flex flex-col gap-8 text-xs md:text-sm mb-3'>
        ...
        <li>
          <NavLink
            to="concern" // Update this to your products route
            className={({ isActive }) =>
              `flex items-center rounded-lg font-bold p-2 ${isActive ? 'bg-blue-400 text-white' : 'hover:bg-blue-400 hover:text-white'}`
            }
          >
            <FaBox className='mr-2' /> Our Concern
          </NavLink>
        </li>
        <li>
          <NavLink
        ...
        <li>
          <NavLink
            to="our-clients" // Update this to your stores route
            className={({ isActive }) =>
              `flex items-center rounded-lg font-bold p-2 ${isActive ? 'bg-blue-400 text-white' : 'hover:bg-blue-400 hover:text-white'}`
            }
          >
            <FaStore className='mr-2' /> Our Client
          </NavLink>
        </li>

        <li>
          <NavLink
            to="news-event-recruitment" // Update this to your stores route
            className={({ isActive }) =>
              `flex items-center rounded-lg font-bold p-2 ${isActive ? 'bg-blue-400 text-white' : 'hover:bg-blue-400 hover:text-white'}`
            }
          >
            <FaStore className='mr-2' /> News And Events
          </NavLink>
        </li>
