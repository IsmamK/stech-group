...
function CompanyValues() {
  ...
  const values = [
    ...
    { id: 2, name: "Innovation", valuenow: 95 },
    { id: 3, name: "Excellence", valuenow: 98 },
    { id: 4, name: "Customer Focus", valuenow: 97 },
    { id: 5, name: "Social Responsibility", valuenow: 90 }
  ];
      ...
      <div className="container">
        <div className="row g-4 g-lg-0 align-items-center">
          <div className="col-lg-5 col-12">
            ...
            <div
              className="companyvalue-thumbnail"
