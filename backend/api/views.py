...
class Ourconcern(JsonDBView):
    model_name = 'our-concern'

class OurconcernHome(JsonDBView):
    model_name = 'our-concern-home'

class ClientView(JsonDBView):
    model_name = 'client-home'
...
class OurServiceView(JsonDBView):
    model_name = 'our-service'

class OurResponsibilities(JsonDBView):
    model_name = 'our-responsibility'

class OurClientView(JsonDBView):
    model_name = 'our-client'

class DescriptionView(JsonDBView):
    model_name = 'event-description'

class RecruitmentView(JsonDBView):
    model_name = 'recruitment'

class NewsEventsView(JsonDBView):
    model_name = 'news-events'

class CompanyValues(JsonDBView):
    model_name = 'company_values'

class OurStrengthView(JsonDBView):
    model_name = 'our-strength'
...
class OurConcernHomeView(JsonDBView):
    model_name = 'our-concern-slug'
